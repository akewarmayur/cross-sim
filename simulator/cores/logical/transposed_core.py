...
from simulator.parameters.core.core import CoreMappingParameters
...
class TransposedCore(AnalogCore):
    ...
    def mapping(self) -> CoreMappingParameters:
        ...
        return CoreMappingParameters(
            weights=self.parent.mapping.weights,
            inputs={
                "_match": self.parent.mapping.inputs.match,
                "mvm": self.parent.mapping.inputs.vmm,
                "vmm": self.parent.mapping.inputs.mvm,
            },
        )
